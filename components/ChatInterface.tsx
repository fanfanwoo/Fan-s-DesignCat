...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ chatSession, onClose }) => {
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'I have analyzed your design. You can ask me to "visualize improvements" or "create a new version" to see code.' }
  ]);
