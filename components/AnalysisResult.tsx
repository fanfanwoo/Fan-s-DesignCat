...
const AnalysisResult: React.FC<AnalysisResultProps> = ({ result, scores, image, chatSession, onReset }) => {
            ...
            {image ? (
              <div className="relative rounded-xl overflow-hidden border border-slate-200 dark:border-slate-600 shadow-lg bg-slate-100 dark:bg-slate-900">
                ...
                <div className="absolute top-2 right-2">
                   <button className="p-1.5 bg-white/90 dark:bg-slate-900/80 text-slate-700 dark:text-white rounded-full hover:bg-white dark:hover:bg-slate-800 transition-colors shadow-sm">
                     <Download size={14} />
                   </button>
                </div>
              </div>
